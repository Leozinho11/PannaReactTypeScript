...
import InputUploadImageView from './input-upload-image-matchday-view'
...
const InputUploadMatchDayImage: React.FC<InputUploadImageProps> = ({
  urlImage,
  hasError,
  handleSelectedImage,
  title
...
export default InputUploadMatchDayImage
